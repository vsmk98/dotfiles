(unless (>= 24 emacs-major-version)
  (error "The qvintvs theme requires Emacs 24 or later!"))

(deftheme qvintvs "The Qvintvs colour theme")

(defgroup qvintvs nil
  "Qvintvs theme options.
The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom qvintvs-distinct-fringe-background nil
  "Make the fringe background different from the normal background color.
Also affects 'linum-mode' background."
  :type 'boolean
  :group 'qvintvs)

(defcustom qvintvs-use-variable-pitch t
  "Use variable pitch face for some headings and titles."
  :type 'boolean
  :group 'qvintvs)

(defcustom qvintvs-high-contrast-mode-line nil
  "Make the active/inactive mode line stand out more."
  :type 'boolean
  :group 'qvintvs)

(defcustom qvintvs-height-minus-1 0.8
  "Font size -1."
  :type 'number
  :group 'qvintvs)

(defcustom qvintvs-height-plus-1 1.1
  "Font size +1."
  :type 'number
  :group 'qvintvs)

(defcustom qvintvs-height-plus-2 1.15
  "Font size +2."
  :type 'number
  :group 'qvintvs)

(defcustom qvintvs-height-plus-3 1.2
  "Font size +3."
  :type 'number
  :group 'qvintvs)

(defcustom qvintvs-height-plus-4 1.3
  "Font size +4."
  :type 'number
  :group 'qvintvs)
...
(defun create-qvintvs-theme (&optional frame)
  "Create the qvintvs theme.
Takes and optional `FRAME' as reference."
  (let* ((class '((class color) (min-colors 89)))
	 ...
	 ;; (yellow-d           (if (in-terminal) "#CDC673" "#E6DB74"))
	 ...
	 ;; (blue-d             (if (in-terminal) "#5FD7FF" "#66D9EF"))
	 ...
	 ;; (green-d            (if (in-terminal) "#87D700" "#A6E22E"))
         ...
         ;; Adaptive colors
         (qvintvs-fg       (if (in-terminal) "#F5F5F5" "#F8F8F2"))
         (qvintvs-bg       (if (in-terminal) "#1B1E1C" "#1D2021"))
         (qvintvs-hl-line  (if (in-terminal) "#212121" "#161A1F"))
         (qvintvs-hl       (if (in-terminal) "#303030" "#465459"))
         (qvintvs-emph     (if (in-terminal) "#FFFAFA" "#F8F8F0"))
         (qvintvs-comments (if (in-terminal) "#8B8878" "#505c63"))

         ;; Adaptive higher/lower contrast accented colors
         (qvintvs-fg-hc    (if (in-terminal) "#171A0B" "#141414"))
         (qvintvs-fg-lc    (if (in-terminal) "#141414" "#171A0B"))
         ...
         (s-variable-pitch (if qvintvs-use-variable-pitch
                               'variable-pitch 'default))
         (s-fringe-bg (if qvintvs-distinct-fringe-background
                          qvintvs-hl qvintvs-bg))

         (s-mode-line-fg (if qvintvs-high-contrast-mode-line
                             qvintvs-bg qvintvs-fg))
         (s-mode-line-bg (if qvintvs-high-contrast-mode-line
                             qvintvs-fg qvintvs-hl-line))
         (s-mode-line-buffer-id-fg (if qvintvs-high-contrast-mode-line
                                       'unspecified green))
         (s-mode-line-inactive-fg (if qvintvs-high-contrast-mode-line
                                      qvintvs-fg qvintvs-comments))
         (s-mode-line-inactive-bg (if qvintvs-high-contrast-mode-line
                                      qvintvs-hl-line qvintvs-bg))
         (s-mode-line-inactive-bc (if qvintvs-high-contrast-mode-line
                                      qvintvs-fg qvintvs-hl-line)))
    (custom-theme-set-faces
     ...
     ;; basic coloring
     `(default
        ((,class (:foreground ,qvintvs-fg
                              :background ,qvintvs-bg))))

     `(shadow
       ((,class (:foreground ,qvintvs-comments))))

     `(match
       ((,class (:background ,qvintvs-hl
                             :foreground ,qvintvs-emph
                             :weight bold))))

     `(cursor
       ((,class (:foreground ,qvintvs-bg
                             :background ,qvintvs-fg
                             :inverse-video t))))
     ...
     `(cua-rectangle-noselect
       ((,class (:inherit region
                          :background ,qvintvs-hl
                          :foreground ,qvintvs-comments))))
     ...
     `(ecb-tree-guide-line-face
       ((,class (:inherit ecb-default-general-face
                          :foreground ,qvintvs-hl
                          :height 1.0))))

     ;; ee
     `(ee-bookmarked
       ((,class (:foreground ,qvintvs-emph))))
     ...
     `(ace-jump-face-foreground
       ((,class (:foreground ,red :background ,qvintvs-bg
                             :inverse-video nil
                             :weight bold))))
     ...
     `(font-latex-italic-face
       ((,class (:inherit italic :foreground ,qvintvs-emph))))
     ...
     `(font-latex-slide-title-face
       ((,class (:inherit (,s-variable-pitch font-lock-type-face)
                          :weight bold
                          :height ,qvintvs-height-plus-3))))

     `(font-latex-string-face
       ((,class (:foreground ,cyan))))

     `(font-latex-subscript-face
       ((,class (:height ,qvintvs-height-minus-1))))
     ...
     `(cfw:face-title
       ((,class (:inherit ,s-variable-pitch
                          :foreground ,yellow
                          :weight bold :height ,qvintvs-height-plus-4))))
     ...
     `(ediff-even-diff-A
       ((,class (:background ,qvintvs-comments
                             :foreground ,qvintvs-fg-lc ))))

     `(ediff-odd-diff-A
       ((,class (:background ,qvintvs-comments
                             :foreground ,qvintvs-fg-hc ))))
     ...
     ;; hl-line-mode
     `(hl-line
       ((,class (:background ,qvintvs-hl-line
                             :inherit t))))
     ...
     `(magit-log-head-label-default
       ((,class (:background ,qvintvs-hl :box 1))))
     ...
     `(org-agenda-structure
       ((,class (:foreground ,qvintvs-emph
                             ...
                             :height ,qvintvs-height-plus-1
                             :underline nil
                             :box (:line-width 2 :color ,qvintvs-bg)))))
     ...
     `(org-agenda-date
       ((,class (:foreground ,qvintvs-comments
                             ...
                             :slant normal
                             :height 1.0
                             :box (:line-width 2 :color ,qvintvs-bg)))) t)
    ...
    (custom-theme-set-variables
     'qvintvs
     `(ansi-color-names-vector [,qvintvs-bg ,red ,green ,yellow
                                            ,blue ,magenta ,cyan ,qvintvs-fg])

     ;; compilation
     `(compilation-message-face 'default)

     ;; fill-column-indicator
     `(fci-rule-color ,qvintvs-hl)
     ...
     `(highlight-tail-colors
       '((,qvintvs-hl . 0)(,green-lc . 20)(,cyan-lc . 30)(,blue-lc . 50)
         (,yellow-lc . 60)(,orange-lc . 70)(,magenta-lc . 85)(,qvintvs-hl . 100)))
     ...
     ;; weechat
     `(weechat-color-list
       '(unspecified ,qvintvs-bg ,qvintvs-hl
                     ,red-d ,red
                     ,green-d ,green
                     ,yellow-d ,yellow
                     ,blue-d ,blue
...
(create-qvintvs-theme)

(add-hook 'server-visit-hook 'create-qvintvs-theme )

(provide-theme 'qvintvs)
